...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{figures/metagenomic/hiseq-phylum-effect-sizes_v01.png}
	\caption[Effect sizes of bacterial phyla classified in the metagenomic analysis.]{
		...
		\todo[color=green!20]{Add vertical line at 0.}
	}
...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{figures/mixed/chao1-richness_v02.png}
	\caption[Richness of antibiotic resistance genes, mobile genetic elements, and integron gene cassette open reading frames.]{
		...
		\todo[color=green!20]{Change p $<$ 0.05 within the figure to asterisks.
		Add a), b), and c).}
	}
...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{figures/mixed/pca-ordplots-args-mges-integrons_v02.png}
	\caption[Principal component analysis ordination plots of metagenomic antibiotic resistance genes, metagenomic mobile genetic elements, and integron gene cassette open reading frames.]{
		...
		\todo[color=green!20]{Increase font size for this figure and add a), b), and c).}
	}
...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{figures/metagenomic/effect-sizes-sig-args_v05.png}
	\caption[Effect sizes of differentially abundant metagenomic antibiotic resistance genes and their target drug classes.]{
		...
		\todo{Ed:
					Hopefully my modifications to the text (with a lot of help from Vera) clarified that metagenomic ARGs were not subject to the confidence-level approach that we used for the integron gene cassette ORFs ---
					All of the ARG hits in this plot are of quite high-confidence.
					Re: \textit{mexP} and other ARGs with multi-drug resistance in the heatmap plot, this information is all determined by CARD (e.g. \url{https://card.mcmaster.ca/ontology/40350}).
					Re: The ARGs associated with quinolones being identified as ribosome-targeting, I think you may be looking at the tetracycline column to the left of the quinolones.
					I could add a grid to this heatmap to help with visually discerning the columns.
					}
	}
	\label{fig:effect-sizes-sig-args}
\end{figure}

\missingfigure{Supplementary Figure: Set intersections plot.}
...
\begin{figure}[htpb]
	...
	\caption[Counts of target drug classes for enriched metagenomic antibiotic resistance genes.]{
		...
		\todo{Ed:
					...
					Re: "Here and elsewhere, does the conservative vs liberal CARD approach need to be spelled out?"
					Please see my comment under Figure \ref{fig:effect-sizes-sig-args}.
		}
	}
...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{figures/metagenomic/pca-ordplots-drug-classes_v02.png}
	\caption[Principal component analysis ordination plots of metagenomic antibiotic resistance genes grouped by target drug class.]{
		...
		PERMANOVA pseudo-$F$ and $p$-values with 999 permutations are displayed.
		\todo[color=green!20]{Increase font size for this plot.}
	}
	\label{fig:pca-ordplots-drug-classes}
\end{figure}

Seven ARGs had significantly decreased relative abundances relative to the control soil: five in the high dose and two in the low dose ($p$ $<$ 0.05).
...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{figures/metagenomic/effect-sizes-sig-mges_v02.png}
	\caption[Effect sizes of differentially abundant metagenomic mobile genetic elements.]{
		...
		Horizontal lines intersecting with circles are error bars, indicating the extent of Bonferroni-adjusted 95\% confidence intervals of effect sizes.
		\todo{Vera: I changed the wording of this figure caption to hopefully clarify what the GenBank number is representing. Does this make sense / was this phrased correctly?}
		\todo[color=green!20]{Increase font size of this plot.}
	}
...
\todo{The FDR of ANCOM-BC is probably close to 1\% \ldots Would it be interesting/useful to test this?}

\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{figures/integron/effect-sizes-sig-integron-orfs_v02.png}
...
\todo{A supplementary table with summary statistics for antibiotic resistance gene identification in integron gene cassette open reading frames.}
...
\missingfigure{Supplementary Figure: Heatmap of antibiotic resistance gene drug classes targeted by putative gene-cassetted embedded antibiotic resistance genes for each confidence level.}
\missingfigure{Supplementary Figure: Heatmap of antibiotic resistance gene drug resistance mechanisms of each putative gene-cassetted embedded antibiotic resistance genes for each confidence level.}
...
\missingfigure{Supplementary Figure: Bar plot of counts of COG functional categories assigned to integron gene cassette open reading frames.}
\missingfigure{Supplementary Figure: Effect size plot of integron gene cassette open reading frames, grouped by COG functional category.}
